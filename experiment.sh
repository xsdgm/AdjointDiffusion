...
do
    ...
    do
        ...
        do
            ...
            DIR_FLAGS="--model_path /home/user/dongjin/1.bending_waveguide/models/wg-64_class-cond/ema_0.9999_025000.pt \
                        --log_dir /home/user/dongjin/1.bending_waveguide/logs/wg-64_class-cond/model_025000/sim-guided/${prop}_tsr=${tsr}_class=${manual_class_id}_eta=${eta}"
